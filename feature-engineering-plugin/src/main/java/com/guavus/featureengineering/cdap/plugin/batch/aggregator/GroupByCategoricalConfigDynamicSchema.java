 ...
 */
public class GroupByCategoricalConfigDynamicSchema extends AggregatorConfig {
	...
	public GroupByCategoricalConfigDynamicSchema() {
		this.groupByFields = "";
		this.aggregates = "";
	}

	@VisibleForTesting
	GroupByCategoricalConfigDynamicSchema(String groupByFields, String aggregates) {
