...
public abstract class NumberFunction implements AggregateFunction<Number> {
    ...
    if (fieldSchema == null) {
      typedDelegate = new AggregateFunction<Double>() {
        ...
        public void operateOn(StructuredRecord record) {
          ...
          if(val != null && val.toString().equals("true") || val.toString().equals("false")) {
        	  updateDouble(val.toString().equals("true")?1:0);
          } else if (val != null) {
            updateDouble(((Number)val).doubleValue());
          }
        }
    ...
    switch (fieldType) {
      ...
      case BOOLEAN:
          typedDelegate = new AggregateFunction<Integer>() {
            ...
            @Override
            public void operateOn(StructuredRecord record) {
              Boolean val = record.get(fieldName);
              if (val != null) {
                updateBoolean(val);
              }
            }
  ...
  protected abstract void startBoolean();
  ...
  protected abstract void updateBoolean(boolean val);
