 ...
 */
public class MultiInputGroupByCategoricalConfigDynamicSchema extends AggregatorConfig {
	...
	public MultiInputGroupByCategoricalConfigDynamicSchema() {
		this.groupByFields = "";
		this.aggregates = "";
	}

	@VisibleForTesting
	MultiInputGroupByCategoricalConfigDynamicSchema(String groupByFields, String aggregates, String categoricalDictionary) {
