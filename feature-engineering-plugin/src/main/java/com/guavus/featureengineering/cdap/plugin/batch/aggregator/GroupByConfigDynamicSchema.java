...
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Avg;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Count;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.CountAll;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.First;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Last;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Max;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Min;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.NUniq;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Stddev;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Sum;
import com.guavus.featureengineering.cdap.plugin.batch.aggregator.function.Variance;
 ...
 */
public class GroupByConfigDynamicSchema extends AggregatorConfig {
	...
	public GroupByConfigDynamicSchema() {
		this.groupByFields = "";
		this.aggregates = "";
	...
	@VisibleForTesting
	GroupByConfigDynamicSchema(String groupByFields, String aggregates, String categoricalColumnsToBeChecked, String lastStageName) {
	...
	static class FunctionInfo {
		...
		public AggregateFunction getAggregateFunction(Schema fieldSchema) {
			...
			case NUNIQ:
				return new NUniq(field, fieldSchema);
			}
			// should never happen
	...
	enum Function {
		COUNT, SUM, AVG, MIN, MAX, FIRST, LAST, STDDEV, VARIANCE, NUNIQ
	}
}
